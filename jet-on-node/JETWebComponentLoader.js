...
JETWebComponentLoader.init = function (app) {
  ...
  if (jetWebComponentsConfigExists) {
    ...
    // to access private repositories, you need to be provide a github token; for public repo access, not authentication is required
    // see: (https://github.com/settings/tokens)

    // create GitHub authentication token
    var gitToken = process.env.GITHUB_TOKEN || "<your token>"
